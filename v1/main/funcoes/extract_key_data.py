...
def extractDadosCNHFrente(imageText):
    ...
    rg_inicio = re.search("DOC\.? IDENTIDADE/ORG\.? EMISSOR/U[F|P]", imageText["texts"][0]).span()[1]
    ...
    cnh_inicio = re.search("REGISTRO-?", imageText["texts"][0]).span()[1]
    ...
    nome_fim = re.search("N?O? ?REGISTRO|Ek", imageText["texts"][0]).span()[0]
    dados["nome"] = imageText["texts"][0][nome_inicio:nome_fim].strip()
    ...
    data_nascimento_fim = re.search("CPF|VALIDADE", imageText["texts"][0]).span()[0]
